...
注解的使用很是简单，我们只需要在正确的位置加入正确的注解就行了。

## 注解基础 <a href="#zhu-jie-ji-chu" id="zhu-jie-ji-chu"></a>
...
### Java内置注解 <a href="#java-nei-zhi-zhu-jie" id="java-nei-zhi-zhu-jie"></a>
...
### 元注解 <a href="#yuan-zhu-jie" id="yuan-zhu-jie"></a>
...
`@Repeatable`请参考[Java 8 - 重复注解](https://pdai.tech/md/java/java8/java8-anno-repeat.html)

#### &#x20;**元注解 - @Native (Java8)**

使用 @Native 注解修饰成员变量，则表示这个变量可以被本地代码引用，常常被代码生成工具使用。对于 @Native 注解不常使用，了解即可

### 注解与反射接口 <a href="#zhu-jie-yu-fan-she-jie-kou" id="zhu-jie-yu-fan-she-jie-kou"></a>
